...
Here is an example based on `template-formula/huginn/config/file.sls`_:
...
.. _template-formula/huginn/config/file.sls: https://github.com/saltstack-formulas/template-formula/blob/master/huginn/config/file.sls
